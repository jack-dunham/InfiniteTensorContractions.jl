...
function _projectedge!(
    ...
    u::UV, 
    v::UV
) where {S,T<:AbstractTensorMap{S,1,2}, M<:AbstractTensorMap{0,4}, UV<:AbstractTensorMap{2,1}}
...
function _projectedge!(
    ...
    u::UV, 
    v::UV,
)where {S,N,T<:AbstractTensorMap{S,2,2}, M<:AbstractTensorMap{N,4}, UV<:AbstractTensorMap{3,1}}
...
function _projectedge!(
    ...
    u::UV, 
    v::UV,
) where {S,T<:AbstractTensorMap{S,2,2}, M<:AbstractTensorMap{1,4}, UV<:AbstractTensorMap{3,1}}
    @tensoropt (
        k => 2,
        D1 => D,
        D2 => D,
...
function _projectedge!(
    ...
    u::UV, 
    v::UV,
) where {S,T<:AbstractTensorMap{S,2,2}, M<:AbstractTensorMap{2,4}, UV<:AbstractTensorMap{3,1}}
    @tensoropt (
        k => 2,
        b => 2,
        D1 => D,
...
function halfcontract(
    ...
    M_21::M, 
    T2_31::T
) where {S, C<:AbstractTensorMap{S,1,1},T<:AbstractTensorMap{S,1,2}, M<:AbstractTensorMap{S,0,4}}
...
function halfcontract(
    ...
    M_21a::M,
    T2_31::T,
) where {S, N, C<:AbstractTensorMap{S,1,1}, T<:AbstractTensorMap{S,2,2}, M<:AbstractTensorMap{S,N,4}}
    return halfcontract(C1_00, T1_10,T1_20,C2_30,T4_01,M_11a,M_11a, M_21a, M_21a, T2_31)
end
...
function halfcontract(
    ...
    M_21b::M,
    T2_31::T,
) where {S, C<:AbstractTensorMap{S,1,1}, T<:AbstractTensorMap{S,2,2}, M<:AbsTen{1,4}}
    @tensoropt (
        k1 => 2,
        k2 => 2,
        D1 => D,
...
function halfcontract(
    ...
    M_21b::M,
    T2_31::T,
) where {S, C<:AbstractTensorMap{S,1,1}, T<:AbstractTensorMap{S,2,2}, M<:AbsTen{2,4}}
    @tensoropt (
        k1 => 2,
        k2 => 2,
        b1 => 2,
